...
public class ExpertOrderDto {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExpertOrderDto)) return false;

        ExpertOrderDto that = (ExpertOrderDto) o;

        if (courseAcceptedOrders != that.courseAcceptedOrders) return false;
        if (courseCapacity != that.courseCapacity) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + courseCapacity;
        result = 31 * result + courseAcceptedOrders;
