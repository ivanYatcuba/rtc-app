...
var classStats = new Array(
        ...
        [ "net.github.rtc.app.dao.impl.GenericDaoImpl", "net.github.rtc.app.dao.impl", "false", "0", "", "", "", "" ],
        ...
        [ "net.github.rtc.app.model.course.Course", "net.github.rtc.app.model.course", "false", "9", "", "9", "", "" ],
        ...
        [ "net.github.rtc.app.model.user.User", "net.github.rtc.app.model.user", "false", "8", "", "8", "", "" ],
...
var packageStats = new Array(
        ...
        [ "net.github.rtc.app.model.course", "9", "", "9", "", "" ],

        [ "net.github.rtc.app.model.report", "2", "", "2", "", "" ],

        [ "net.github.rtc.app.model.user", "14", "", "14", "", "" ],
...
var bugs = new Array(
        ...
        [ "172003e6ab279dfe45a8c7affdc150b0-0",
            "MALICIOUS_CODE",
            "EI2",
            "EI_EXPOSE_REP2",
            2,
        ...
        [ "49a85b84378c5f1742b465b82fc2d85e-0",
            "MALICIOUS_CODE",
            "EI2",
            "EI_EXPOSE_REP2",
            2,
        ...
        [ "f9fae2e41923284008ea5c9732f79d0f-0",
            "MALICIOUS_CODE",
            "EI2",
            "EI_EXPOSE_REP2",
            2,
        ...
        [ "82a2696c4a9cf3574f0bf076681d3c7b-0",
            "MALICIOUS_CODE",
            "EI2",
            "EI_EXPOSE_REP2",
            2,
        ...
        [ "1abfa43792aa460a5950daffcfcb1798-0",
            "MALICIOUS_CODE",
            "EI2",
            "EI_EXPOSE_REP2",
            2,
...
<div style="" id="menuWrapper">
    <div id="navcontainer">
        <ul id="navlist">
            <li>
                <a onclick="selectMenu('summary'); return false;" href="#"
                   class="current" id="summary">Summary</a>
            </li>
            <li>
                <a onclick="selectMenu('history'); return false;" href="#"
                   class="none" id="history">History</a>
            </li>
            <li>
                <a onclick="selectMenu('listByCategories'); return false;"
                   href="#" class="none" id="listByCategories">Browse By
                    Categories</a>
            </li>
            <li>
                <a onclick="selectMenu('listByPackages'); return false;"
                   href="#" class="none" id="listByPackages">Browse by
                    Packages</a>
            </li>
            <li>
                <a onclick="selectMenu('info'); return false;" href="#"
                   class="none" id="info">Info</a>
            </li>
        </ul>
    </div>
</div>
    ...
    <div style="display:none;" id="historyControlWrapper">
        <form name="findbugsHistoryControlForm">
            <div id="historyControlContainer">
                <input onclick="includeFixedIntroducedBugsInHistory()"
                       alt="Include fixed introduced bugs." value="checked"
                       name="includeFixedIntroducedBugs" type="checkbox"/>
...
<ul>
<li>
    D:\.m2\repository\org\codehaus\mojo\findbugs-maven-plugin\3.0.0\findbugs-maven-plugin-3.0.0.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\gmaven\gmaven-mojo\1.4\gmaven-mojo-1.4.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\gmaven\runtime\gmaven-runtime-api\1.4\gmaven-runtime-api-1.4.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\gmaven\feature\gmaven-feature-api\1.4\gmaven-feature-api-1.4.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\gmaven\runtime\gmaven-runtime-1.5\1.4\gmaven-runtime-1.5-1.4.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\gmaven\feature\gmaven-feature-support\1.4\gmaven-feature-support-1.4.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\groovy\groovy-all-minimal\1.5.8\groovy-all-minimal-1.5.8.jar
</li>
<li>D:\.m2\repository\org\apache\ant\ant\1.8.2\ant-1.8.2.jar</li>
<li>
    D:\.m2\repository\org\apache\ant\ant-launcher\1.8.2\ant-launcher-1.8.2.jar
</li>
<li>D:\.m2\repository\jline\jline\0.9.94\jline-0.9.94.jar</li>
<li>
    D:\.m2\repository\org\codehaus\plexus\plexus-interpolation\1.1\plexus-interpolation-1.1.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\gmaven\gmaven-plugin\1.4\gmaven-plugin-1.4.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\gmaven\runtime\gmaven-runtime-loader\1.4\gmaven-runtime-loader-1.4.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\gmaven\runtime\gmaven-runtime-support\1.4\gmaven-runtime-support-1.4.jar
</li>
<li>
    D:\.m2\repository\org\sonatype\gshell\gshell-io\2.4\gshell-io-2.4.jar
</li>
<li>
    D:\.m2\repository\com\thoughtworks\qdox\qdox\1.12\qdox-1.12.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\shared\file-management\1.2.1\file-management-1.2.1.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\shared\maven-shared-io\1.1\maven-shared-io-1.1.jar
</li>
<li>
    D:\.m2\repository\commons-lang\commons-lang\2.6\commons-lang-2.6.jar
</li>
<li>
    D:\.m2\repository\org\slf4j\slf4j-api\1.5.10\slf4j-api-1.5.10.jar
</li>
<li>
    D:\.m2\repository\org\sonatype\gossip\gossip\1.2\gossip-1.2.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\reporting\maven-reporting-impl\2.1\maven-reporting-impl-2.1.jar
</li>
<li>
    D:\.m2\repository\commons-validator\commons-validator\1.2.0\commons-validator-1.2.0.jar
</li>
<li>
    D:\.m2\repository\commons-beanutils\commons-beanutils\1.7.0\commons-beanutils-1.7.0.jar
</li>
<li>
    D:\.m2\repository\commons-digester\commons-digester\1.6\commons-digester-1.6.jar
</li>
<li>
    D:\.m2\repository\commons-logging\commons-logging\1.0.4\commons-logging-1.0.4.jar
</li>
<li>D:\.m2\repository\oro\oro\2.0.8\oro-2.0.8.jar</li>
<li>D:\.m2\repository\xml-apis\xml-apis\1.0.b2\xml-apis-1.0.b2.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\groovy\groovy-all\1.7.4\groovy-all-1.7.4.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\reporting\maven-reporting-api\3.0\maven-reporting-api-3.0.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\doxia\doxia-core\1.1.3\doxia-core-1.1.3.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\doxia\doxia-logging-api\1.1.3\doxia-logging-api-1.1.3.jar
</li>
<li>D:\.m2\repository\xerces\xercesImpl\2.9.1\xercesImpl-2.9.1.jar
</li>
<li>
    D:\.m2\repository\commons-httpclient\commons-httpclient\3.1\commons-httpclient-3.1.jar
</li>
<li>
    D:\.m2\repository\commons-codec\commons-codec\1.2\commons-codec-1.2.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\doxia\doxia-sink-api\1.1.3\doxia-sink-api-1.1.3.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\doxia\doxia-decoration-model\1.1.3\doxia-decoration-model-1.1.3.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\doxia\doxia-site-renderer\1.1.3\doxia-site-renderer-1.1.3.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\doxia\doxia-module-xhtml\1.1.3\doxia-module-xhtml-1.1.3.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\doxia\doxia-module-fml\1.1.3\doxia-module-fml-1.1.3.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\plexus\plexus-i18n\1.0-beta-7\plexus-i18n-1.0-beta-7.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\plexus\plexus-velocity\1.1.7\plexus-velocity-1.1.7.jar
</li>
<li>
    D:\.m2\repository\org\apache\velocity\velocity\1.5\velocity-1.5.jar
</li>
<li>
    D:\.m2\repository\commons-collections\commons-collections\3.2\commons-collections-3.2.jar
</li>
<li>
    D:\.m2\repository\org\apache\maven\shared\maven-doxia-tools\1.2.1\maven-doxia-tools-1.2.1.jar
</li>
<li>D:\.m2\repository\commons-io\commons-io\1.4\commons-io-1.4.jar
</li>
<li>
    D:\.m2\repository\com\google\code\findbugs\findbugs\3.0.0\findbugs-3.0.0.jar
</li>
<li>
    D:\.m2\repository\com\google\code\findbugs\bcel-findbugs\6.0\bcel-findbugs-6.0.jar
</li>
<li>
    D:\.m2\repository\com\google\code\findbugs\annotations\3.0.0\annotations-3.0.0.jar
</li>
<li>
    D:\.m2\repository\com\google\code\findbugs\jFormatString\3.0.0\jFormatString-3.0.0.jar
</li>
<li>D:\.m2\repository\dom4j\dom4j\1.6.1\dom4j-1.6.1.jar</li>
<li>D:\.m2\repository\jaxen\jaxen\1.1.6\jaxen-1.1.6.jar</li>
<li>
    D:\.m2\repository\org\ow2\asm\asm-debug-all\5.0.2\asm-debug-all-5.0.2.jar
</li>
<li>D:\.m2\repository\jgoodies\plastic\1.2.0\plastic-1.2.0.jar</li>
<li>
    D:\.m2\repository\org\codehaus\plexus\plexus-resources\1.0-alpha-7\plexus-resources-1.0-alpha-7.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\plexus\plexus-utils\1.5.6\plexus-utils-1.5.6.jar
</li>
<li>
    D:\.m2\repository\org\sonatype\plexus\plexus-build-api\0.0.7\plexus-build-api-0.0.7.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-core\4.0.6.RELEASE\spring-core-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\commons-logging\commons-logging\1.1.3\commons-logging-1.1.3.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-context-support\4.0.6.RELEASE\spring-context-support-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-beans\4.0.6.RELEASE\spring-beans-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-context\4.0.6.RELEASE\spring-context-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-web\4.0.6.RELEASE\spring-web-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-aop\4.0.6.RELEASE\spring-aop-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-webmvc\4.0.6.RELEASE\spring-webmvc-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-expression\4.0.6.RELEASE\spring-expression-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-tx\4.0.6.RELEASE\spring-tx-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-orm\4.0.6.RELEASE\spring-orm-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\spring-jdbc\4.0.6.RELEASE\spring-jdbc-4.0.6.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\security\spring-security-core\3.2.4.RELEASE\spring-security-core-3.2.4.RELEASE.jar
</li>
<li>
    D:\.m2\repository\aopalliance\aopalliance\1.0\aopalliance-1.0.jar
</li>
<li>
    D:\.m2\repository\org\springframework\security\spring-security-web\3.2.4.RELEASE\spring-security-web-3.2.4.RELEASE.jar
</li>
<li>
    D:\.m2\repository\org\springframework\security\spring-security-config\3.2.4.RELEASE\spring-security-config-3.2.4.RELEASE.jar
</li>
<li>
    D:\.m2\repository\javax\servlet\servlet-api\2.5\servlet-api-2.5.jar
</li>
<li>
    D:\.m2\repository\org\freemarker\freemarker\2.3.20\freemarker-2.3.20.jar
</li>
<li>
    D:\.m2\repository\org\hibernate\hibernate-validator\5.0.1.Final\hibernate-validator-5.0.1.Final.jar
</li>
<li>
    D:\.m2\repository\javax\validation\validation-api\1.1.0.Final\validation-api-1.1.0.Final.jar
</li>
<li>
    D:\.m2\repository\org\jboss\logging\jboss-logging\3.1.1.GA\jboss-logging-3.1.1.GA.jar
</li>
<li>
    D:\.m2\repository\com\fasterxml\classmate\0.8.0\classmate-0.8.0.jar
</li>
<li>
    D:\.m2\repository\com\sun\jersey\jersey-client\1.9.1\jersey-client-1.9.1.jar
</li>
<li>
    D:\.m2\repository\com\sun\jersey\jersey-core\1.9.1\jersey-core-1.9.1.jar
</li>
<li>
    D:\.m2\repository\com\sun\jersey\jersey-server\1.9.1\jersey-server-1.9.1.jar
</li>
<li>D:\.m2\repository\asm\asm\3.1\asm-3.1.jar</li>
<li>
    D:\.m2\repository\com\sun\jersey\jersey-json\1.9.1\jersey-json-1.9.1.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\jettison\jettison\1.1\jettison-1.1.jar
</li>
<li>D:\.m2\repository\stax\stax-api\1.0.1\stax-api-1.0.1.jar</li>
<li>
    D:\.m2\repository\com\sun\xml\bind\jaxb-impl\2.2.3-1\jaxb-impl-2.2.3-1.jar
</li>
<li>
    D:\.m2\repository\javax\xml\bind\jaxb-api\2.2.2\jaxb-api-2.2.2.jar
</li>
<li>
    D:\.m2\repository\javax\xml\stream\stax-api\1.0-2\stax-api-1.0-2.jar
</li>
<li>
    D:\.m2\repository\javax\activation\activation\1.1\activation-1.1.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\jackson\jackson-core-asl\1.8.3\jackson-core-asl-1.8.3.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\jackson\jackson-mapper-asl\1.8.3\jackson-mapper-asl-1.8.3.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\jackson\jackson-jaxrs\1.8.3\jackson-jaxrs-1.8.3.jar
</li>
<li>
    D:\.m2\repository\org\codehaus\jackson\jackson-xc\1.8.3\jackson-xc-1.8.3.jar
</li>
<li>
    D:\.m2\repository\org\mockito\mockito-all\1.9.5\mockito-all-1.9.5.jar
</li>
<li>D:\.m2\repository\joda-time\joda-time\2.1\joda-time-2.1.jar</li>
<li>
    D:\.m2\repository\org\slf4j\slf4j-api\1.6.1\slf4j-api-1.6.1.jar
</li>
<li>
    D:\.m2\repository\org\slf4j\slf4j-simple\1.6.1\slf4j-simple-1.6.1.jar
</li>
<li>
    D:\.m2\repository\ch\qos\logback\logback-core\0.9.28\logback-core-0.9.28.jar
</li>
<li>
    D:\.m2\repository\ch\qos\logback\logback-classic\0.9.28\logback-classic-0.9.28.jar
</li>
<li>
    D:\.m2\repository\commons-dbcp\commons-dbcp\1.2.2\commons-dbcp-1.2.2.jar
</li>
<li>
    D:\.m2\repository\commons-pool\commons-pool\1.3\commons-pool-1.3.jar
</li>
<li>
    D:\.m2\repository\mysql\mysql-connector-java\5.1.30\mysql-connector-java-5.1.30.jar
</li>
<li>
    D:\.m2\repository\org\hibernate\hibernate-core\4.2.2.Final\hibernate-core-4.2.2.Final.jar
</li>
<li>D:\.m2\repository\antlr\antlr\2.7.7\antlr-2.7.7.jar</li>
<li>
    D:\.m2\repository\org\jboss\spec\javax\transaction\jboss-transaction-api_1.1_spec\1.0.1.Final\jboss-transaction-api_1.1_spec-1.0.1.Final.jar
</li>
<li>
    D:\.m2\repository\org\hibernate\javax\persistence\hibernate-jpa-2.0-api\1.0.1.Final\hibernate-jpa-2.0-api-1.0.1.Final.jar
</li>
<li>
    D:\.m2\repository\org\hibernate\common\hibernate-commons-annotations\4.0.2.Final\hibernate-commons-annotations-4.0.2.Final.jar
</li>
<li>
    D:\.m2\repository\org\javassist\javassist\3.15.0-GA\javassist-3.15.0-GA.jar
</li>
<li>
    D:\.m2\repository\com\googlecode\json-simple\json-simple\1.1.1\json-simple-1.1.1.jar
</li>
<li>
    D:\.m2\repository\org\reflections\reflections\0.9.9-RC1\reflections-0.9.9-RC1.jar
</li>
<li>D:\.m2\repository\com\google\guava\guava\r05\guava-r05.jar</li>
<li>
    D:\.m2\repository\org\quartz-scheduler\quartz\2.2.1\quartz-2.2.1.jar
</li>
<li>D:\.m2\repository\c3p0\c3p0\0.9.1.1\c3p0-0.9.1.1.jar</li>
<li>
    D:\.m2\repository\org\apache\poi\poi\3.10-FINAL\poi-3.10-FINAL.jar
</li>
<li>
    D:\.m2\repository\commons-codec\commons-codec\1.5\commons-codec-1.5.jar
</li>
<li>
    D:\.m2\repository\org\apache\poi\poi-ooxml\3.10-FINAL\poi-ooxml-3.10-FINAL.jar
</li>
<li>
    D:\.m2\repository\org\apache\poi\poi-ooxml-schemas\3.10-FINAL\poi-ooxml-schemas-3.10-FINAL.jar
</li>
<li>
    D:\.m2\repository\org\apache\xmlbeans\xmlbeans\2.3.0\xmlbeans-2.3.0.jar
</li>
<li>
    D:\.m2\repository\org\liquibase\liquibase-core\3.2.2\liquibase-core-3.2.2.jar
</li>
<li>D:\.m2\repository\org\yaml\snakeyaml\1.13\snakeyaml-1.13.jar
</li>
<li>
    D:\.m2\repository\net\github\rtc\rtc-util\1.1-RELEASE\rtc-util-1.1-RELEASE.jar
</li>
<li>
    D:\.m2\repository\com\fasterxml\jackson\core\jackson-core\2.2.2\jackson-core-2.2.2.jar
</li>
<li>
    D:\.m2\repository\com\fasterxml\jackson\core\jackson-databind\2.2.2\jackson-databind-2.2.2.jar
</li>
<li>
    D:\.m2\repository\com\fasterxml\jackson\core\jackson-annotations\2.2.2\jackson-annotations-2.2.2.jar
</li>
<li>
    D:\.m2\repository\commons-io\commons-io\1.3.2\commons-io-1.3.2.jar
</li>
</ul>
</div>
...
<div id="tip-DM_DEFAULT_ENCODING" class="tip">
    ...
    <p> Found a call to a method which will perform a byte to String (or String
...
<div id="tip-OBL_UNSATISFIED_OBLIGATION_EXCEPTION_EDGE" class="tip">
    ...
    <ul>
        ...
        <li>file a bug report: <a
                href="http://findbugs.sourceforge.net/reportingBugs.html">http://findbugs.sourceforge.net/reportingBugs.html</a>
        </li>
    </ul>
...
<div id="tip-RV_RETURN_VALUE_IGNORED_BAD_PRACTICE" class="tip">
    ...
    <p> This method returns a value that is not checked. The return value should
        be checked
...
<div id="tip-NP_NULL_ON_SOME_PATH" class="tip">
    ...
    <p> There is a branch of statement that, <em>if executed,</em> guarantees
        that
...
<div class="bug" style="display:none;"
     id="b-uid-f2348d81d8f8b6a9e1584c26a960222c-0">
    <div class="b-r">In class
        net.github.rtc.app.controller.admin.ExportController
    </div>
    <div class="b-r">In method
        net.github.rtc.app.controller.admin.ExportController.downloadUserExport(HttpServletResponse,
        String)
    </div>
    <div class="b-r">Reference type java.io.InputStream</div>
    <div class="b-r">1 instances of obligation remaining</div>
    <div class="b-r">Obligation to clean up resource created at
        ExportController.java:[line 150] is not discharged
    </div>
    <div class="b-r">Path continues at ExportController.java:[line 152]</div>
    <div class="b-r">Remaining obligations: {InputStream x 1}</div>
    <div class="b-d">
        net.github.rtc.app.controller.admin.ExportController.downloadUserExport(HttpServletResponse,
        String) may fail to clean up java.io.InputStream on checked exception
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-3fe134943db43556893d89cf535c3be4-0">
    <div class="b-r">In class net.github.rtc.app.export.JobManager</div>
    <div class="b-r">In method
        net.github.rtc.app.export.JobManager.manageJob(ReportDetails,
        JobManagerAction)
    </div>
    <div class="b-r">Called method java.io.File.delete()</div>
    <div class="b-r">At JobManager.java:[line 59]</div>
    <div class="b-d">Exceptional return value of java.io.File.delete() ignored
        in net.github.rtc.app.export.JobManager.manageJob(ReportDetails,
        JobManagerAction)
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-cc4d74a70d51553ef7ad1e8b16639e2b-0">
    <div class="b-r">In class net.github.rtc.app.export.ReportBuilder</div>
    <div class="b-r">In method
        net.github.rtc.app.export.ReportBuilder.build(List, List, String,
        String, ExportFormat)
    </div>
    ...
    <div class="b-d">Possible null pointer dereference of reportTable in
        net.github.rtc.app.export.ReportBuilder.build(List, List, String,
        String, ExportFormat)
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-c5f1a6e3faee0e9eeb1619e9544bb1ae-0">
    <div class="b-r">In class net.github.rtc.app.export.table.CSVTable</div>
    <div class="b-r">In method
        net.github.rtc.app.export.table.CSVTable.writeToFile(String)
    </div>
    <div class="b-r">Called method new java.io.FileWriter(String)</div>
    <div class="b-r">At CSVTable.java:[line 32]</div>
    <div class="b-d">Found reliance on default encoding in
        net.github.rtc.app.export.table.CSVTable.writeToFile(String): new
        java.io.FileWriter(String)
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-f94682a48ff1bc0fe296b3492213a538-0">
    <div class="b-r">In class net.github.rtc.app.export.table.CSVTable</div>
    <div class="b-r">In method
        net.github.rtc.app.export.table.CSVTable.writeToFile(String)
    </div>
    ...
    <div class="b-r">1 instances of obligation remaining</div>
    <div class="b-r">Obligation to clean up resource created at
        CSVTable.java:[line 32] is not discharged
    </div>
    ...
    <div class="b-d">
        net.github.rtc.app.export.table.CSVTable.writeToFile(String) may fail to
        clean up java.io.Writer on checked exception
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-725b0f8467a65a5f2927ada4c53cefe4-0">
    <div class="b-r">In class net.github.rtc.app.export.table.XLSNXTable</div>
    <div class="b-r">In method
        net.github.rtc.app.export.table.XLSNXTable.writeToFile(String)
    </div>
    <div class="b-r">Reference type java.io.OutputStream</div>
    <div class="b-r">1 instances of obligation remaining</div>
    <div class="b-r">Obligation to clean up resource created at
        XLSNXTable.java:[line 54] is not discharged
    </div>
    <div class="b-r">Path continues at XLSNXTable.java:[line 55]</div>
    <div class="b-r">Remaining obligations: {OutputStream x 1}</div>
    <div class="b-d">
        net.github.rtc.app.export.table.XLSNXTable.writeToFile(String) may fail
        to clean up java.io.OutputStream on checked exception
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-2afbeacaa2b6eae418f319314dd773e9-0">
    <div class="b-r">In class net.github.rtc.app.export.table.XLSNXTable</div>
    <div class="b-r">In method
        net.github.rtc.app.export.table.XLSNXTable.writeToFile(String)
    </div>
    ...
    <div class="b-d">Exceptional return value of java.io.File.createNewFile()
        ignored in
        net.github.rtc.app.export.table.XLSNXTable.writeToFile(String)
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-a73f8d86a16b8fb355fc79857b3e5d09-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method
        net.github.rtc.app.model.course.Course.getEndDate()
    </div>
    <div class="b-r">Field net.github.rtc.app.model.course.Course.endDate</div>
    <div class="b-r">At Course.java:[line 130]</div>
    <div class="b-d">net.github.rtc.app.model.course.Course.getEndDate() may
        expose internal representation by returning Course.endDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-b9e82145fc4b22e5e7c06db17e2ca86d-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method
        net.github.rtc.app.model.course.Course.getPublishDate()
    </div>
    <div class="b-r">Field net.github.rtc.app.model.course.Course.publishDate
    </div>
    <div class="b-r">At Course.java:[line 178]</div>
    <div class="b-d">net.github.rtc.app.model.course.Course.getPublishDate() may
        expose internal representation by returning Course.publishDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-6c87ec86afe625f800c4fda9b20c81e9-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method
        net.github.rtc.app.model.course.Course.getStartDate()
    </div>
    <div class="b-r">Field net.github.rtc.app.model.course.Course.startDate
    </div>
    <div class="b-r">At Course.java:[line 122]</div>
    <div class="b-d">net.github.rtc.app.model.course.Course.getStartDate() may
        expose internal representation by returning Course.startDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-172003e6ab279dfe45a8c7affdc150b0-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method new
        net.github.rtc.app.model.course.Course(String, String, CourseType, Set,
        Date, Date, Date, Integer, String, CourseStatus)
    </div>
    <div class="b-r">Field net.github.rtc.app.model.course.Course.endDate</div>
    <div class="b-r">Local variable named endDate</div>
    <div class="b-r">At Course.java:[line 213]</div>
    <div class="b-d">new net.github.rtc.app.model.course.Course(String, String,
        CourseType, Set, Date, Date, Date, Integer, String, CourseStatus) may
        expose internal representation by storing an externally mutable object
        into Course.endDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-49a85b84378c5f1742b465b82fc2d85e-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method new
        net.github.rtc.app.model.course.Course(String, String, CourseType, Set,
        Date, Date, Date, Integer, String, CourseStatus)
    ...
    <div class="b-d">new net.github.rtc.app.model.course.Course(String, String,
        CourseType, Set, Date, Date, Date, Integer, String, CourseStatus) may
        expose internal representation by storing an externally mutable object
        into Course.publishDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-f9fae2e41923284008ea5c9732f79d0f-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method new
        net.github.rtc.app.model.course.Course(String, String, CourseType, Set,
        Date, Date, Date, Integer, String, CourseStatus)
    ...
    <div class="b-d">new net.github.rtc.app.model.course.Course(String, String,
        CourseType, Set, Date, Date, Date, Integer, String, CourseStatus) may
        expose internal representation by storing an externally mutable object
        into Course.startDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-5536ffa6c3b49698ec4cb5ec415cdefd-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method
        net.github.rtc.app.model.course.Course.setEndDate(Date)
    </div>
    <div class="b-r">Field net.github.rtc.app.model.course.Course.endDate</div>
    <div class="b-r">Local variable named endDate</div>
    <div class="b-r">At Course.java:[line 134]</div>
    <div class="b-d">net.github.rtc.app.model.course.Course.setEndDate(Date) may
        expose internal representation by storing an externally mutable object
        into Course.endDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-c02b432ac560e82e52df8e5583f7ae2b-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method
        net.github.rtc.app.model.course.Course.setPublishDate(Date)
    </div>
    <div class="b-r">Field net.github.rtc.app.model.course.Course.publishDate
    </div>
    <div class="b-r">Local variable named publishDate</div>
    <div class="b-r">At Course.java:[line 182]</div>
    <div class="b-d">net.github.rtc.app.model.course.Course.setPublishDate(Date)
        may expose internal representation by storing an externally mutable
        object into Course.publishDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-3eee85b07f632f459fdb8dc6f8a334c8-0">
    <div class="b-r">In class net.github.rtc.app.model.course.Course</div>
    <div class="b-r">In method
        net.github.rtc.app.model.course.Course.setStartDate(Date)
    </div>
    <div class="b-r">Field net.github.rtc.app.model.course.Course.startDate
    </div>
    <div class="b-r">Local variable named startDate</div>
    <div class="b-r">At Course.java:[line 126]</div>
    <div class="b-d">net.github.rtc.app.model.course.Course.setStartDate(Date)
        may expose internal representation by storing an externally mutable
        object into Course.startDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-1e1ad131d41af9576c01dad7377ce55-0">
    <div class="b-r">In class net.github.rtc.app.model.report.ReportDetails
    </div>
    <div class="b-r">In method
        net.github.rtc.app.model.report.ReportDetails.getCreatedDate()
    </div>
    <div class="b-r">Field
        net.github.rtc.app.model.report.ReportDetails.createdDate
    </div>
    <div class="b-r">At ReportDetails.java:[line 101]</div>
    <div class="b-d">
        net.github.rtc.app.model.report.ReportDetails.getCreatedDate() may
        expose internal representation by returning ReportDetails.createdDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-6780ac4da9b290a0496a6f4cef34f9b2-0">
    <div class="b-r">In class net.github.rtc.app.model.report.ReportDetails
    </div>
    <div class="b-r">In method
        net.github.rtc.app.model.report.ReportDetails.setCreatedDate(Date)
    </div>
    <div class="b-r">Field
        net.github.rtc.app.model.report.ReportDetails.createdDate
    </div>
    ...
    <div class="b-d">
        net.github.rtc.app.model.report.ReportDetails.setCreatedDate(Date) may
        expose internal representation by storing an externally mutable object
        into ReportDetails.createdDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-c21f6a2c222e1c2d19241f378629faf8-0">
    <div class="b-r">In class net.github.rtc.app.model.user.User</div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.User.getBirthDate()
    </div>
    <div class="b-r">Field net.github.rtc.app.model.user.User.birthDate</div>
    <div class="b-r">At User.java:[line 303]</div>
    <div class="b-d">net.github.rtc.app.model.user.User.getBirthDate() may
        expose internal representation by returning User.birthDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-91276797e9fa3e541eb6c9c916413650-0">
    <div class="b-r">In class net.github.rtc.app.model.user.User</div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.User.getRegisterDate()
    </div>
    <div class="b-r">Field net.github.rtc.app.model.user.User.registerDate</div>
    <div class="b-r">At User.java:[line 327]</div>
    <div class="b-d">net.github.rtc.app.model.user.User.getRegisterDate() may
        expose internal representation by returning User.registerDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-f78df78cef32c8a662c5c5ac0d006d27-0">
    <div class="b-r">In class net.github.rtc.app.model.user.User</div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.User.getRemovalDate()
    </div>
    <div class="b-r">Field net.github.rtc.app.model.user.User.removalDate</div>
    <div class="b-r">At User.java:[line 335]</div>
    <div class="b-d">net.github.rtc.app.model.user.User.getRemovalDate() may
        expose internal representation by returning User.removalDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-82a2696c4a9cf3574f0bf076681d3c7b-0">
    <div class="b-r">In class net.github.rtc.app.model.user.User</div>
    <div class="b-r">In method new net.github.rtc.app.model.user.User(String,
        String, String, String, String, String, Date, String, String, String,
        String, String, String, String, Set, String)
    </div>
    <div class="b-r">Field net.github.rtc.app.model.user.User.birthDate</div>
    <div class="b-r">Local variable named birthDate</div>
    <div class="b-r">At User.java:[line 395]</div>
    <div class="b-d">new net.github.rtc.app.model.user.User(String, String,
        String, String, String, String, Date, String, String, String, String,
        String, String, String, Set, String) may expose internal representation
        by storing an externally mutable object into User.birthDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-1abfa43792aa460a5950daffcfcb1798-0">
    <div class="b-r">In class net.github.rtc.app.model.user.User</div>
    <div class="b-r">In method new net.github.rtc.app.model.user.User(String,
        String, String, String, String, Date, String, String, String, String,
    ...
    <div class="b-d">new net.github.rtc.app.model.user.User(String, String,
        String, String, String, Date, String, String, String, String, String,
        String, String, Set, String) may expose internal representation by
        storing an externally mutable object into User.birthDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-7905a5b44a304d4f9b37ce458f13137c-0">
    <div class="b-r">In class net.github.rtc.app.model.user.User</div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.User.setBirthDate(Date)
    </div>
    <div class="b-r">Field net.github.rtc.app.model.user.User.birthDate</div>
    <div class="b-r">Local variable named birthDate</div>
    <div class="b-r">At User.java:[line 307]</div>
    <div class="b-d">net.github.rtc.app.model.user.User.setBirthDate(Date) may
        expose internal representation by storing an externally mutable object
        into User.birthDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-e83cdd5403fc6c4de5536ba885d7e1ea-0">
    <div class="b-r">In class net.github.rtc.app.model.user.User</div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.User.setRegisterDate(Date)
    </div>
    <div class="b-r">Field net.github.rtc.app.model.user.User.registerDate</div>
    <div class="b-r">Local variable named registerDate</div>
    <div class="b-r">At User.java:[line 331]</div>
    <div class="b-d">net.github.rtc.app.model.user.User.setRegisterDate(Date)
        may expose internal representation by storing an externally mutable
        object into User.registerDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-9a6e41a06caebe3d9be0247091507f-0">
    <div class="b-r">In class net.github.rtc.app.model.user.User</div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.User.setRemovalDate(Date)
    </div>
    <div class="b-r">Field net.github.rtc.app.model.user.User.removalDate</div>
    <div class="b-r">Local variable named removalDate</div>
    <div class="b-r">At User.java:[line 339]</div>
    <div class="b-d">net.github.rtc.app.model.user.User.setRemovalDate(Date) may
        expose internal representation by storing an externally mutable object
        into User.removalDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-7ade47ccbbc2730a511488ce1ccd8f6e-0">
    <div class="b-r">In class net.github.rtc.app.model.user.UserCourseOrder
    </div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.UserCourseOrder.getRequestDate()
    </div>
    <div class="b-r">Field
        net.github.rtc.app.model.user.UserCourseOrder.requestDate
    </div>
    <div class="b-r">At UserCourseOrder.java:[line 89]</div>
    <div class="b-d">
        net.github.rtc.app.model.user.UserCourseOrder.getRequestDate() may
        expose internal representation by returning UserCourseOrder.requestDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-1478645d3370d2e50e4b1c754c7702c0-0">
    <div class="b-r">In class net.github.rtc.app.model.user.UserCourseOrder
    </div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.UserCourseOrder.getResponseDate()
    </div>
    <div class="b-r">Field
        net.github.rtc.app.model.user.UserCourseOrder.responseDate
    </div>
    <div class="b-r">At UserCourseOrder.java:[line 81]</div>
    <div class="b-d">
        net.github.rtc.app.model.user.UserCourseOrder.getResponseDate() may
        expose internal representation by returning UserCourseOrder.responseDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-d2488b1648b0bf5ca51e9a87212a8a97-0">
    <div class="b-r">In class net.github.rtc.app.model.user.UserCourseOrder
    </div>
    <div class="b-r">In method new
        net.github.rtc.app.model.user.UserCourseOrder(String, String, Date,
        Date, UserRequestStatus, TraineePosition)
    </div>
    <div class="b-r">Field
        net.github.rtc.app.model.user.UserCourseOrder.requestDate
    </div>
    ...
    <div class="b-d">new net.github.rtc.app.model.user.UserCourseOrder(String,
        String, Date, Date, UserRequestStatus, TraineePosition) may expose
        internal representation by storing an externally mutable object into
        UserCourseOrder.requestDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-c6b00182162e90b6d0e7db0518b6dca6-0">
    <div class="b-r">In class net.github.rtc.app.model.user.UserCourseOrder
    </div>
    <div class="b-r">In method new
        net.github.rtc.app.model.user.UserCourseOrder(String, String, Date,
    ...
    <div class="b-d">new net.github.rtc.app.model.user.UserCourseOrder(String,
        String, Date, Date, UserRequestStatus, TraineePosition) may expose
        internal representation by storing an externally mutable object into
        UserCourseOrder.responseDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-4df94521a15ce30fb6e1a3be3cfb7d2f-0">
    <div class="b-r">In class net.github.rtc.app.model.user.UserCourseOrder
    </div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.UserCourseOrder.setRequestDate(Date)
    </div>
    <div class="b-r">Field
        net.github.rtc.app.model.user.UserCourseOrder.requestDate
    </div>
    ...
    <div class="b-d">
        net.github.rtc.app.model.user.UserCourseOrder.setRequestDate(Date) may
        expose internal representation by storing an externally mutable object
        into UserCourseOrder.requestDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-1ec67227d8ae7715b8ac208de27209a1-0">
    <div class="b-r">In class net.github.rtc.app.model.user.UserCourseOrder
    </div>
    <div class="b-r">In method
        net.github.rtc.app.model.user.UserCourseOrder.setResponseDate(Date)
    </div>
    <div class="b-r">Field
        net.github.rtc.app.model.user.UserCourseOrder.responseDate
    </div>
    ...
    <div class="b-d">
        net.github.rtc.app.model.user.UserCourseOrder.setResponseDate(Date) may
        expose internal representation by storing an externally mutable object
        into UserCourseOrder.responseDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-6a336e276249458bbe549d928c1d1222-0">
    <div class="b-r">In class net.github.rtc.app.service.impl.UserServiceImpl
    </div>
    <div class="b-r">In method
        net.github.rtc.app.service.impl.UserServiceImpl.update(User)
    </div>
    <div class="b-r">Actual type String</div>
    <div class="b-r">Return value of
        net.github.rtc.app.model.user.User.getPassword()
    </div>
    <div class="b-r">At UserServiceImpl.java:[line 86]</div>
    <div class="b-d">Comparison of String objects using == or != in
        net.github.rtc.app.service.impl.UserServiceImpl.update(User)
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-feb84ae17379b0d30a250ccc3de7e7d7-0">
    <div class="b-r">In class
        net.github.rtc.app.utils.datatable.CourseSearchFilter
    </div>
    <div class="b-r">In method
        net.github.rtc.app.utils.datatable.CourseSearchFilter.getCriteria()
    </div>
    <div class="b-r">Actual type String</div>
    <div class="b-r">Expected net.github.rtc.app.model.course.CourseStatus</div>
    <div class="b-r">String constant ""</div>
    <div class="b-r">Value loaded from field
        net.github.rtc.app.utils.datatable.CourseSearchFilter.status
    </div>
    <div class="b-r">Enum.equals(Object) used to determine equality</div>
    <div class="b-r">At CourseSearchFilter.java:[line 90]</div>
    <div class="b-d">Call to
        net.github.rtc.app.model.course.CourseStatus.equals(String) in
        net.github.rtc.app.utils.datatable.CourseSearchFilter.getCriteria()
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-15ce7ab046d98ad701a60bc63cf5789c-0">
    <div class="b-r">In class
        net.github.rtc.app.utils.datatable.CourseSearchFilter
    </div>
    <div class="b-r">In method
        net.github.rtc.app.utils.datatable.CourseSearchFilter.getStartDate()
    </div>
    <div class="b-r">Field
        net.github.rtc.app.utils.datatable.CourseSearchFilter.startDate
    </div>
    <div class="b-r">At CourseSearchFilter.java:[line 47]</div>
    <div class="b-d">
        net.github.rtc.app.utils.datatable.CourseSearchFilter.getStartDate() may
        expose internal representation by returning CourseSearchFilter.startDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-fe6f014c88d1069e6ab7e9e9c5952a0c-0">
    <div class="b-r">In class
        net.github.rtc.app.utils.datatable.CourseSearchFilter
    </div>
    <div class="b-r">In method
        net.github.rtc.app.utils.datatable.CourseSearchFilter.setStartDate(Date)
    </div>
    <div class="b-r">Field
        net.github.rtc.app.utils.datatable.CourseSearchFilter.startDate
    </div>
    ...
    <div class="b-d">
        net.github.rtc.app.utils.datatable.CourseSearchFilter.setStartDate(Date)
        may expose internal representation by storing an externally mutable
        object into CourseSearchFilter.startDate
    </div>
</div>
<div class="bug" style="display:none;"
     id="b-uid-6f56d382153754cedadef83e7dc65ccd-0">
    ...
    <div class="b-d">Unread field:
        net.github.rtc.app.utils.datatable.Page.first; should this field be
        static?
    </div>
</div>
</div>
